...
int main()
{
    ...
    InterfaceV = true;
    cout << "Выберите операцию(1 - сложение, 2 - вычетание, 3 - умножение на константу, 4 - перемена знаков в матрицы(внос,вынос минуса из матрицы), 5 - выход.)" << endl;
    cin >> pickV;
    if(pickV == 1)
    {
    system("cls");
        ...
        if(pickV == 4)
    {
            ...
            cout << "Полученная матрица -(A):" << endl;
            for( i=0; i<i_A; i++ )
                {
                    cout << "|";
                    for (j=0; j<j_A; j++)
